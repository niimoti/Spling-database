...
let kekkacom = [],kekkapro = [],selectcom = [], answered = false, id, quebo = true
...
function RadioNo() {
    ...
    question.innerHTML = str + '<button type="submit">回答</button>'
}
...
function SelectPro(num, checked) {
    ...
    str2 += '<button type="submit">送信</button>'
...
function RemoveCom(num) {
    ...
    str += '<button type="submit">送信</button>'
